...
namespace Gray
{
	...
	public:
		cQueueDyn(ITERATE_t nGrowSizeChunk = 128, ITERATE_t nGrowSizeMax = (CHeap::k_ALLOC_MAX / sizeof(TYPE)))
		...
		void put_GrowSizeChunk(ITERATE_t nGrowSizeChunk)
		{
		...
		ITERATE_t get_GrowSizeChunk() const
		{
