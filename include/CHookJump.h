...
namespace Gray
{
	...
	public:
		...
		static const int k_LEN_P = 4;	//!< size of the relative pointer. NOT same as sizeof(FARPROC)
#ifdef USE_64BIT
	...
	protected:
		FARPROC m_pFuncOrig;			//!< Pointer to the original/old function. The one i will replace.
