...
class GRAYCORE_LINK cWinHeap {
 ...
 public:
    ...
    cWinHeap(HANDLE hHeap, bool bManaged = true) noexcept : m_hHeap(hHeap), m_bManaged(bManaged) {
        //! Attach existing handle to this class.
    }
    cWinHeap(DWORD flOptions, SIZE_T dwInitialSize = 0, SIZE_T dwMaximumSize = 0) noexcept : m_hHeap(::HeapCreate(flOptions, dwInitialSize, dwMaximumSize)), m_bManaged(true) {
