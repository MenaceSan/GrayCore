...
#define GRAY_VERSION_S		"1.6.7.0"		//!< share string version with all files. ToVersionStr()
#define GRAY_VERSION_RC		1,6,7,0			//!< RC version id. *.rc FILEVERSION wants this format.
