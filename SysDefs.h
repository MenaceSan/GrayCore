...
//! Can be included from an .RC file.
...
#ifdef RC_INVOKED
// Resource compiler only wants preprocessor defines.
#define GRAY_COMPILER_NAME "Rc"
#define GRAY_COMPILER_VER 1
...
#endif
#ifndef _MFC_VER // should be defined in <afxwin.h>
#error NO _MFC_VER?
#endif
#include <afxtempl.h>		// MFC Templates. CArray.
#include <Winsock2.h>	// must get loaded before afx.h to prevent problems with _WINSOCKAPI_ vs _WINSOCK2API_ in VC2013 with _AFXDLL, _MFC_VER
...
#define _WINDOWS_
#elif ! defined(_WINDOWS_) // should be defined in <afxwin.h> !
