...
#define UNITTEST_N(n)			CUnitTest_##n			//!< Pick a unique name for the test.
#define UNITTEST_EXT(n)			g_pCUnitTest_##n		//!< a base pointer to class UNITTEST_N(n)
...
#define UNITTEST_PREDEF(n)		class UNITTEST_N(n); extern Gray::CUnitTestRegister* UNITTEST_EXT(n);	
