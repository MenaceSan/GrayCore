...
namespace Gray
{
	...
	struct GRAYCORE_LINK DECLSPEC_NOVTABLE IFileCopy
	{
		//! @struct Gray::IFileCopy
		...
		IGNORE_WARN_ABSTRACT(IFileCopy);
	...
	public:
		...
		static void GRAYCALL UnitTest_CopyTo(IFileCopy* pDst);
		static void GRAYCALL UnitTest_CopyFrom(IFileCopy* pSrc);
		UNITTEST_FRIEND(cFile);
#endif
	};

	class GRAYCORE_LINK cFileCopy : public IFileCopy
	{
		//! @class Gray::cFileCopy
		//! Implement the IFileCopy for the local file system. Copy single files.
